...
uglifyjs -c --output all.min.js -- jquery.min.js jquery.lettering.js Chart.min.js chartjs-plugin-dragData.min.js error-chart.js autoscroll.js ajax-api.js index.min.js
cd ../styles
uglifycss --output all.min.css bulma.min.css infobox.css bootstrap-float-label.min.css balloon.min.css Chart.min.css overlay.css #bulma-switch.min.css
